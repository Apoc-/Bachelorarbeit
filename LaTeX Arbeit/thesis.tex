...
\subsection{Analyse der Domäne}
\subsubsection{Entwicklung einer Referenzimplementation}
\subsubsection{Definition von Variabilitäten}
\subsubsection{Formulierung der Domäne als abstraktes Metamodell}
\subsection{Anreicherung des Metamodells mit konkreten Daten}
\subsubsection{Wahl einer geeigneten Schnittstelle}
\subsubsection{Implementation einer DSL}
\subsection{Generator vs. Transformator}
\subsubsection{Eingesetzte Technik}
\subsubsection{Neuentwicklung}
\subsubsection{Vorhandene Frameworks als Basis}
\subsection{Verwendung von Zwischenmodellen}
\section{Wirtschaftliche Probleme}
\subsection{Aufwandsvergleich zwischen MDSD und konventioneller Softwareentwicklung}
\subsection{Erhöhung der Wirtschaftlichkeit durch Verwendung eines Meta-Generators}
\section{Spezielle Probleme bei der Entwicklung eines Meta-Generators für Java-Code}
\subsection{Java-Code als Ausgangsmodell}
\subsubsection{Informationsanreicherung des Java-Code-Modells}
\subsubsection{Parsen des Codes und Umsetzung in ein neues Modell}
\subsubsection{Einschränkung auf eine Teilmenge der Java Features}
\subsection{Modell zur Plattform unabhängigen Abbildung von Code}
\subsubsection{DSL als beschreibende Schnittstelle für den Entwickler}
\subsubsection{xxx}
\subsection{Besonderheiten bei der Abwägung zwischen Generator und Transformator}
