...
Von der Erfindung auswechselbarer Teile 1901 bei Ransom Olds, über die Weiterentwicklung des Konzepts unter der Verwendung von Fließbändern bei Ford im Jahr 1913, bis hin zur abschließenden Automatisierung mit Industriellen Robotern in den frühen 1980ern \cite{czaeis2000genprog}. Die industrielle Revolution prägte die Autoindustrie. 
...
Es wird in dieser Arbeit weder allgemein noch speziell im Zusammenhang mit dem erarbeiteten Ansatz auf die Wirtschaftlichen Aspekte bei der Verwendung von Code Generatoren eingegangen.
